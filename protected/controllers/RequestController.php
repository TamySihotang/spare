...
class RequestController extends Controller {
    ...
    public function filters() {
        return array(
            ...
            'ajaxOnly + selectspare,selectsn,selectgol',
                );
    }
...
// {
//    $data= Request::model()->findAllByAttributes(array('id_spare'=>$_POST['haha']));
//    $data=CHtml::listData($data,'id_office','branch_office');
//    foreach($data as $value=>$name)
//    {
...
//    public function actionRequest() {
//    $data=  Office::model()->findAllByAttributes(array('order' => 'id_office'), array('id_spare'=>$_POST['haha']));
//    $data = CHtml::listData($data, 'id_office', 'alisname');
//
//        //echo "<option value=''>SN</option>";
//        foreach ($data as $value => $name)
//            echo CHtml::tag('option', array('value' => $value), CHtml::encode($name), true);
...
{
 $id_dest = $_POST['Request']['id_destiny'];
 $list = SpareOffice::model()->findAll('id_office= :id_dest', array(':id_dest'=>$id_dest));
 $list = CHtml::listData($list,'id_spare_off', 'id_spare');
 ...
 public function actionSelectsn()
{
 ...
 $id_sn= $_POST['Request']['id_spare'];
 $list = SparepartList::model()->findAll('id_spare = :id_sn', array(':id_sn'=>$id_sn));
 $list = CHtml::listData($list,'id_sparelist','SN');

 echo CHtml::tag('option',array('value'=>''),'-- Choose SN --', true);
